  ...
  return <>
    ...
    {plansOpen && <Modal title="Planes de compensación" close={() => setPlansOpen(false)}>
      <form className="reconciliation-form" onSubmit={savePlan}>
        ...
        {planDraft.hasCommission && <p className="wide form-error" style={{ background: "transparent", color: "#8b6a1e" }}>Desde el cierre del Final Gate (2026-08-17), la comisión de nómina se calcula automáticamente desde el motor económico (Comisiones → EconomicRule), no desde esta configuración. Esta sección queda disponible para referencia, pero no afecta el cálculo real de Pago de Personal.</p>}
